      ...
      <div className="w-[60%] h-full flex gap-5">
        ...
        <div className="w-[40%] h-full flex flex-col gap-3">
          ...
          <div className="w-[110px] h-[50px] bg-slate-400 flex rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-green-400 text-xl">
            <button
              className="text-green-400 w-[30%] h-full bg-white flex justify-center items-center hover:bg-gray-200"
              onClick={() => dispatch(DecrementQty({ id: id }))}
            >
              -
            </button>
            <span className=" text-green-400 w-[40%] h-full bg-slate-200 flex justify-center items-center">
              {qty}
            </span>
            <button
              className=" text-green-400 w-[30%] h-full bg-white flex justify-center items-center hover:bg-gray-200"
